...
HT.Hexagon.prototype.draw = function(ctx) {
  ...
  if(!this.selected) ctx.strokeStyle = "grey";
...
HT.Hexagon.prototype.isInHexBounds = function( /*Point*/ p) {
  if(this.TopLeftPoint.X < p.X && this.TopLeftPoint.Y < p.Y && p.X < this.BottomRightPoint.X && p.Y < this.BottomRightPoint.Y) return true;
  return false;
};
